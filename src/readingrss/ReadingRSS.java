...
public class ReadingRSS {
    ...
    public static List<List<String>> readBbcRss() throws Exception {
        List<List<String>> titlesAndLinks = new ArrayList<List<String>>();
        //Outcomes of the program
        List<String> newsTitles = new ArrayList<String>();
        List<String> newsLinks = new ArrayList<String>();
        titlesAndLinks.add(newsTitles);
        titlesAndLinks.add(newsLinks);
